...
<head>
    ...
    <script type="text/javascript">
        ...
        grunticon( [ "<?php echo $path; ?>/css/jQuery/jquery.mobile.inline-svg-1.4.5.min.css","<?php echo $path; ?>/css/jQuery/jquery.mobile.inline-png-1.4.5.min.css","<?php echo $path; ?>/css/jQuery/jquery.mobile.external-png-1.4.5.min.css" ] );
    </script>
    <noscript id="grunticon-fallback">
        <link href="<?php echo $path; ?>/css/jQuery/jquery.mobile.icons-1.4.5.min.css" rel="stylesheet">
    </noscript>
