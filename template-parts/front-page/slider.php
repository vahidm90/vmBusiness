...
global $vmbwpt_supported_lang, $vmbwpt_lang, $vmbwpt_comma;
	...
	<ul class="h-100 w-100 anim-slider text-light">
		<li class="anim-slide p-1 p-sm-3 pt-5 pt-sm-5" id="slide-1">
			<div class="slide-content w-100 h-100 position-relative">
				<img src="<?php echo $path; ?>/images/welcome_img.png"
				     alt="<?php _ex( 'Logo', 'Image alt text', 'vmbwpt-en' ); ?>" id="s1-img">
		...
		<li class="anim-slide p-1 p-sm-3 pt-5 pt-sm-5" id="slide-2">
			...
			<div class="slide-content h-100 pt-5 w-50" id="s2-1">
				...
				<p class="slide-text text-white-50 s2-step-4 d-sm-inline-block h6 m-3" id="s2-text-1-3"><?php _e( '60-70', 'vmbwpt-en'); ?></p>
				<p class="slide-text text-white-50 s2-step-5 d-sm-inline-block h6 m-3" id="s2-text-1-4"><?php _e( '80-100', 'vmbwpt-en'); ?></p>
			...
			<div class="slide-content h-100 pt-5 w-50" id="s2-2">
				<p class="slide-text text-warning s2-step-2 h4 mt-2" id="s2-text-2-1"><?php _e( 'Viscosity', 'vmbwpt-en' ); ?></p>
				<p class="slide-text text-warning s2-step-3 d-sm-inline-block h6 m-3" id="s2-text-2-2"><?php _e( 'VG10', 'vmbwpt-en'); ?></p>
				<p class="slide-text text-warning s2-step-4 d-sm-inline-block h6 m-3" id="s2-text-2-3"><?php _e( 'VG20', 'vmbwpt-en'); ?></p>
				<p class="slide-text text-warning s2-step-5 d-sm-inline-block h6 m-3" id="s2-text-2-4"><?php _e( 'VG30', 'vmbwpt-en'); ?></p>
				<p class="slide-text text-warning s2-step-6 d-sm-inline-block h6 m-3" id="s2-text-2-5"><?php _e( 'VG40', 'vmbwpt-en'); ?></p>
		...
		<li class="anim-slide p-1 p-sm-3 pt-5 pt-sm-5" id="slide-3">
            <div class="slide-content w-100 text-center position-static">
                ...
                <p class="slide-text h6 my-1 m-sm-4 p-1 p-sm-3 d-sm-inline-block" id="s3-text-4"><?php _e('R.P.O', 'vmbwpt-en' ); ?></p>
            </div>
		...
		<li class="anim-slide p-1 p-sm-3 pt-5 pt-sm-5" id="slide-4">
			...
			<div class="slide-content position-relative h-100 w-100" id="s4-text-img" style="background-image: url(<?php echo $path; ?>/images/big/export_everywhere.jpg)">
                <div class="slide-content position-absolute h-100 w-50 p-1 p-sm-5" id="s4-1">
                    <p class="slide-text bg-dark h6 p-1 s4-step-1" id="s4-text-1"><?php _e( 'Afghanistan', 'vmbwpt-en' ); ?></p>
                    <p class="slide-text bg-dark h6 p-1 s4-step-2" id="s4-text-2"><?php _e( 'Pakistan', 'vmbwpt-en' ); ?></p>
                    <p class="slide-text bg-dark h6 p-1 s4-step-3" id="s4-text-3"><?php _e( 'Uzbekistan', 'vmbwpt-en' ); ?></p>
                    <p class="slide-text bg-dark h6 p-1 s4-step-4" id="s4-text-4"><?php _e( 'Georgia', 'vmbwpt-en' ); ?></p>
                </div>
                <div class="slide-content position-absolute h-100 w-50 p-1 p-sm-5" id="s4-2">
                    <p class="slide-text bg-dark h6 p-1 s4-step-1" id="s4-text-5"><?php _e( 'India', 'vmbwpt-en' ); ?></p>
                    <p class="slide-text bg-dark h6 p-1 s4-step-2" id="s4-text-6"><?php _e( 'Myanmar', 'vmbwpt-en' ); ?></p>
                    <p class="slide-text bg-dark h6 p-1 s4-step-3" id="s4-text-7"><?php _e( 'Bangladesh', 'vmbwpt-en' ); ?></p>
                    <p class="slide-text bg-dark h6 p-1 s4-step-4" id="s4-text-8"><?php _e( 'Kenya', 'vmbwpt-en' ); ?></p>
                </div>
                <div class="slide-content position-absolute w-100 text-center" id="s4-3">
                    <p class="slide-text d-inline-block bg-dark h6 p-1" id="s4-text-9">
                        <?php _e( 'World-wide coverage', 'vmbwpt-en' ); ?>
                    </p>
                    <br />
                    <p class="slide-text d-inline-block bg-dark h6 p-1" id="s4-text-10">
                        <?php _e( 'Enjoy Your Purchase', 'vmbwpt-en' ); ?>
                    </p>
                </div>
			</div>
		</li>
		...
		<li class="anim-slide p-1 p-sm-3 pt-5 pt-sm-5" id="slide-6">
            <div class="slide-content position-relative text-left">
                ...
                <p class="slide-text h6 m-1 m-sm-3" id="s6-text-2">
		            ...
		            <?php _e( 'From Reliable Producers', 'vmbwpt-en' ); ?>
                </p>
		...
		<li class="anim-slide p-1 p-sm-3 pt-5 pt-sm-5" id="slide-7">
            ...
            <div class="slide-content position-relative mt-2">
                ...
                <p class="slide-text text-light h6 m-1 m-sm-3" id="s7-text-2"><?php _e( 'Drums', 'vmbwpt-en' ); ?></p>
                <p class="slide-text text-light h6 m-1 m-sm-3" id="s7-text-3"><?php _e( 'Flexitanks', 'vmbwpt-en' ); ?></p>
                <p class="slide-text text-light h6 m-1 m-sm-3" id="s7-text-4"><?php _e( 'Jumbo Bags', 'vmbwpt-en' ); ?></p>
            </div>
